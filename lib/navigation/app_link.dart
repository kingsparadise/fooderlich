class AppLink {
  ...
  // information back to a URL string. It essentially encapsulates all the
  // logic that transforms a simple string into a state and back.
// TODO: Add fromLocation
  ...
  // The app will also need the converse transformation,
  // from AppLink to simple string.
